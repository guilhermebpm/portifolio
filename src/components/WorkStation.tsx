export default function WorkStation() {
	return (
		<div className='mx-auto mt-5 h-fit w-full bg-background md:mt-0 md:mb-20 md:w-[577px]'>
			<h3 className='text-left font-bold font-sans text-base text-foreground'>Item Name</h3>
			<p className='mt-4 text-left font-normal font-sans text-base text-foreground leading-[28px] tracking-normal md:leading-7'>
