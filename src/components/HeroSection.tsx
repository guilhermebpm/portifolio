...
export function HeroSection() {
	return (
		<div className='max-w-98 md:max-w-2xl w-full h-full gap-6 opacity-100 rotation-0 py-1 md:pb-0 md:ml-0 bg-background'>
			...
			<h1 className='font-bold font-sans text-[31px] leading-10 md:text-5xl text-foreground text-left md:leading-14 tracking-[-0.01em] max-w-2xl'>Software engineer, father, and believer</h1>
			</div>
			<div className='w-full h-full'>
			<p className='text-foreground text-base font-normal font-sans text-left leading-7 md:leading-7 tracking-normal'>Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi.</p>
			</div>
